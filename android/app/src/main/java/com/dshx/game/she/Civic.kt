...
object Civic {
    ...
    val EXAMS: List<ExamQuestion> = listOf(
        ...
        ExamQuestion("抽水站和水塔靠什么供水？", listOf("必须贴着河岸", "抽取地下水，建在覆盖区内即可", "必须建在山顶", "只能建在公园里"), 1, "抽水站抽的是地下水，不必靠河。"),
        ...
        ExamQuestion("电厂和水厂怎么给分区送电送水？", listOf("只看覆盖半径", "只产能，靠道路预埋管线/地下管缆接到建筑", "替代道路", "只给公园用"), 1, "厂站只负责产能，接不接得上是管线的事；容量不足全城打折。"),
    ...
    val COMPLAINTS: List<Complaint> = listOf(
        Complaint("power", "梧桐小区业主", "家里没电", "小区没接进电网：要么附近没路，要么电缆没连到电厂。", "拉电缆接进电网（-80万，满意+4）", "先发应急灯（满意+1）", 4.0, -80.0, 0.0, 1.0, -10.0, 0.0),
        Complaint("water", "望江里居民", "水龙头没水", "小区没接进水管网：道路没通到，或水厂还没建。", "铺水管接进水厂（-90万，满意+4）", "先送桶装水（满意+1）", 4.0, -90.0, 0.0, 1.0, -15.0, 0.0),
        ...
        Complaint("shop", "金源超市", "店里没电开不了门", "商铺这一片还没接进电网，客人进不来。", "拉电缆接电（-60万，满意+2）", "先减一天商税（税收略降）", 2.0, -60.0, 0.0, 1.0, -25.0, 0.0),
        Complaint("factory", "联华车间", "车间没电停工", "厂区没接进电网，工人没法开工。", "拉电缆接电（-80万）", "先放假一天（满意-1）", 1.0, -80.0, 0.0, -1.0, 0.0, 0.0),
        ...
        Complaint("noise", "临街住户", "晚上吵得睡不着", "垃圾场/工厂/电厂离住宅太近，机器和清运昼夜不停，窗户都不敢开。", "把污染设施挪远/加隔音林（满意+3）", "先发隔音窗补贴（-60万，满意+1）", 3.0, 0.0, 0.0, 1.0, -60.0, 0.0),
        Complaint("foul", "河畔居民", "臭气熏天", "污水厂/垃圾场离住宅太近，风一吹全是味道。", "迁走污染设施（满意+4）", "先做除臭（-70万，满意+1）", 4.0, 0.0, 0.0, 1.0, -70.0, 0.0)
    )
}
