...
object Civic {
    ...
    val EXAMS: List<ExamQuestion> = listOf(
        ...
        ExamQuestion("电站和水塔怎么给分区供电供水？", listOf("靠电缆水管手绘", "建在覆盖半径内，容量还要够", "替代道路", "只给公园用"), 1, "设施按半径覆盖，容量不足全城会打折。"),
    ...
    val COMPLAINTS: List<Complaint> = listOf(
        Complaint("power", "梧桐小区业主", "家里没电", "住宅不在电站覆盖圈里，晚上黑灯瞎火。", "扩电站覆盖（-80万，满意+4）", "先发应急灯（满意+1）", 4.0, -80.0, 0.0, 1.0, -10.0, 0.0),
        Complaint("water", "望江里居民", "水龙头没水", "小区不在水塔/泵站覆盖圈内，做饭洗衣都难。", "扩供水覆盖（-90万，满意+4）", "先送桶装水（满意+1）", 4.0, -90.0, 0.0, 1.0, -15.0, 0.0),
